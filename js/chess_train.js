        ...
        $.post("get_course_info.php", {}, function(result){
          ...
          for(var i = 0; i < arr.length; ++i){
            ...
            if(class_num == "-1"){
              ...
              html_str += "<td ><a style='color:black' href='classroom.html'><span class='span_sty_3' style=\"color:red;\">点击上课 </span></a></td></tr>";
            }else{
              html_str += "<tr>";
              html_str += "<td>"+ course_name + "</td>";
...
function make_qp_con(){
  $.post("get_qp_info.php", {}, function(ret_json){
      // 基础课程
      var arr_1 = new Array();
      // 入门课程
      var arr_2 = new Array();
      ...
      for(key in arr_1){
        html_str += "<td class=\"td_sty\"><a  href=\"practice.html?"+ "零基础&" + key +"\"><font class=\"font_sty_1\" onmouseover=\"this.style.color='red'\" onmouseout=\"this.style.color=''\" >"+ key  +"</font></a></td>";
      }
      ...
      for(key in arr_2){
        html_str += "<td class=\"td_sty\"><a href=\"practice.html?"+ "入门&" + key +"\"><font class=\"font_sty_1\" onmouseover=\"this.style.color='red'\" onmouseout=\"this.style.color=''\" >"+ key  +"</font></a></td>";
      } 
      ...
      for(key in arr_3){
        html_str += "<td class=\"td_sty\"><a href=\"practice.html?"+ "提高&" + key +"\"><font class=\"font_sty_1\" onmouseover=\"this.style.color='red'\" onmouseout=\"this.style.color=''\" >"+ key  +"</font></a></td>";
      }
      ...
      for(key in arr_4){
        html_str += "<td class=\"td_sty\"><a href=\"practice.html?"+ "进阶&" + key +"\"><font class=\"font_sty_1\" onmouseover=\"this.style.color='red'\" onmouseout=\"this.style.color=''\" >"+ key  +"</font></a></td>";
      }
      ...
      for(key in arr_5){
        html_str += "<td class=\"td_sty\"><a href=\"practice.html?"+ "职业化&" + key +"\"><font class=\"font_sty_1\" onmouseover=\"this.style.color='red'\" onmouseout=\"this.style.color=''\" >"+ key +"</font></a></td>";
      }
      html_str += "</tr>"
      html_str += "</tbody>";
      html_str += "</table>";
