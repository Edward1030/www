...
chess_player.prototype.check_stu_tea_ready = function(){
	...
	cfunc = function(retStr){
			...
			if(items[0] == "未知"){
				tea = "老&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;师: <a href='/controller/person_center.php'><span style='color:white'>点击完善“个人信息”/span></a>";
			}
			if(items[1] == "未知"){
				stu = "学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;生: <a href='/controller/person_center.php'><span style='color:white'>点击完善“个人信息”</span></a>";
			}
